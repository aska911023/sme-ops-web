...
import { DashboardMockup } from "./SystemMockups";
    ...
    <section id="timeline" className="relative py-28 lg:py-36 px-6 lg:px-8 bg-[#0E1024]">
      ...
      <div className="relative max-w-[1280px] mx-auto">
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 items-start">
          <div>
            <ScrollReveal>
              <div className="mb-16">
                ...
                <h2 className="font-[var(--font-display)] text-3xl sm:text-4xl lg:text-[2.8rem] font-bold tracking-tight mb-4">
                  <span className="gradient-text">4 週</span>
                  <span className="text-white/50"> 完成導入</span>
                </h2>
                <p className="text-[15px] text-white/50 max-w-md">從需求訪談到正式上線，一個月內完成全部流程。</p>
              </div>
            </ScrollReveal>
                ...
                {STEPS.map((step, i) => (
                  ...
                  >
                    ...
                    <div className="rounded-xl border border-white/[0.06] bg-[#12142A]/60 p-5 hover:border-white/[0.1] transition-colors duration-300">
                      ...
                      <span className="text-[11px] font-bold text-white/40 tracking-wider">{step.week}</span>
          ...
          >
            <div className="animate-float sticky top-32">
              <DashboardMockup />
            </div>
          </motion.div>
        </div>
